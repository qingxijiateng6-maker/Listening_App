...
describe("parseTimedTextXmlCaptions", () => {
  it("parses timedtext xml transcript payloads", () => {
    expect(
      parseTimedTextXmlCaptions(
...
describe("parseSrtCaptions", () => {
  it("parses srt subtitle payloads", () => {
    const cues = parseSrtCaptions("1\n00:00:00,000 --> 00:00:01,000\nHello\n\n2\n00:00:01,500 --> 00:00:02,000\nWorld\n");

    expect(cues).toEqual([
      { startMs: 0, endMs: 1000, text: "Hello" },
      { startMs: 1500, endMs: 2000, text: "World" },
    ]);
  });
});

describe("parseCaptionPayload", () => {
  it("routes payload parsing by extension", () => {
    ...
    expect(
      parseCaptionPayload('<transcript><text start="0.0" dur="0.5">C</text></transcript>', "srv3"),
